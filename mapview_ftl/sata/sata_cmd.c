...
void ata_read_verify_sectors(UINT32 const lba1, UINT32 const sector_count)
{
	send_status_to_host(0);
}

extern unsigned int write_count, gc_count, share_count, copy_back_count, misc_share_count;

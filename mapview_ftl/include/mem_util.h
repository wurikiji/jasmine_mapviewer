...
#define read_dram_64(ADDR)                      _read_dram_64((UINT32) (ADDR))
...
#define get_dram_address(ADDR)                  _get_dram_address((UINT32) (ADDR))
...
UINT64  _read_dram_64(UINT32 const addr);
...
UINT32  _get_dram_address(UINT32 const addr);

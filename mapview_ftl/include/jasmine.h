...
#if 0
#define SWAT_DEBUG 1
#define SWAT_DEBUG2 1 // for share debug
#define DEBUG_SATA 1  // sata pointer debug
#define DEBUG_SATA2 1 // sata pointer debug
#endif
...
#define NUM_LSECTORS (NUM_PSECTORS / 100 * 93) // 30% provisioning
